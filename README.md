...
A study performed by Brave browser (https://brave.com/the-mounting-cost-of-stale-ad-blocking-rules/) seems to support above claim: QUOTE "WE FOUND THAT ONLY 201 RULES ACCOUNTED FOR 90% OF THE BLOCKING ACTIVITY". Because AdGuard* temprarely does not support importing other blocklists, I am using my personal blocklist for the moment and do not see ads either (using less than 200 rules). My personal experience is in line with Brave's study and usage results of W3tech.com (https://w3techs.com/technologies/overview/advertising).

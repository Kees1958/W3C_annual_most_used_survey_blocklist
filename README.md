...
This list works fine with english adfilter of Easylist or Adguard base filter in combination with your local language filtering list. For people using Peter Lowe's list I would either use my list or Peter Low's.
